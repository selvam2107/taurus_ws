...
//for header files we need to use folder name and file name
#include "hw_t/moons_client.h"

class Taurus : public hardware_interface::RobotHW 
{
	public:
        Taurus(ros::NodeHandle& nh);
        ~Taurus();
        void init();
    ...
    protected:
        ...
        std::string joint_name_[2]={"right_wheel","left_wheel"};  
        ...
        double left_motor_vel=0, right_motor_vel=0;
        double left_prev_cmd=0, right_prev_cmd=0;
