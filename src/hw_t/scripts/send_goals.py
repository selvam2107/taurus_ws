...
def movebase_client(x):
	co_pub=rospy.Publisher("path_co",PoseStamped,queue_size=10)
	global done
	done= False
	red.set("goal", "junk")
	...
	# while red.get("task2")==b'done':
	# 	pass
	while red.get('task2')==b'go' or  red.get('task3')==b'go' or red.get('task1')==b'go':
		pass
